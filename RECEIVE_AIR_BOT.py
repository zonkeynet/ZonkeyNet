...
NEW_MSGS_ONLY=True #if you want OLD msgs, change to False

channel_name="#zonkeynet"
log_file_path="/home/youruser/ZonkeyNet/.AirChatLog.json" #path to AirChat or ZonkeyNet folder
IRC_server_address="127.0.0.1" #put your favorite IRC server address here
IRC_nickname="airBOT_receive"
