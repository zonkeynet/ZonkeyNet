...
sub msg_crypt {
    ...
    <tr><input type="submit" id="button" style="height: 45px; width: 170px" value="Send Your Message" >};
...
sub msg_advanced {
    ...
    <textarea name="postfield" rows="6" cols="120" placeholder="Post A Message Here (280 characters max)" maxlength=280 ></textarea></br></tr>
    <tr><td><input type="submit" id=button style="height: 45px; width: 170px" value="Send Your Message" >};
    if ($mustEncrypt eq "yeahbabygetthisoneintoyourassFCCandNSA") {
