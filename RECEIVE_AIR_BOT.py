...
LOCKFILE = "airbot_rx.lock"

lfnam = os.path.abspath(LOCKFILE)
lf = open(lfnam, 'w')
try:
...
log_file_path = "/home/pi/ZonkeyNet/.AirChatLog.json" # Your Log file Location
IRC_server_address = "chat.freenode.net"
IRC_nickname = "airBOT_RX"
IRC_passwd = "password" # Change This!
...
server1.connect(IRC_server_address, 6667, IRC_nickname, IRC_passwd)
